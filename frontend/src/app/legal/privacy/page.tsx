export default function PrivacyPage() {
  return (
    <article className="prose dark:prose-invert max-w-none">
      ...
      <p className="text-muted-foreground"><strong>Last updated:</strong> April 19, 2026</p>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>Azure (Hosting)</td><td>Infrastructure — United States (East)</td><td>All data (encrypted at rest and in transit)</td></tr>
        </tbody>
      </table>

      <h2>4. Data Storage and Security</h2>
      <ul>
        <li>All data is stored on Azure Database for PostgreSQL in the United States (Azure East US region) with encryption at rest.</li>
      ...
      <p>
        WadeCV is operated from the United States and all personal data we process — including your CV
        content, account information, and generated documents — is stored and processed on Microsoft Azure
        infrastructure in the United States (Azure East US region). If you access WadeCV from the United
        Kingdom, the European Economic Area, or any other jurisdiction outside the United States, your
        personal data will be transferred to and processed in the United States.
      </p>
      <p>
        <strong>Legal basis for the transfer.</strong> For users in the United Kingdom and the EEA, we rely
        on Article 49(1)(b) of the UK GDPR and EU GDPR — the transfer is necessary for the performance of
        the contract between you and WadeCV. Delivering the WadeCV service requires processing your CV and
        job description data on our US-hosted infrastructure; no equivalent UK or EEA-hosted instance of
        the service exists. By creating an account and submitting CV or job data, you understand and agree
        that this transfer is necessary to provide the service you have requested.
      </p>
      <p>
        <strong>Risks you should be aware of.</strong> The United States is not currently recognised by the
        UK Information Commissioner&apos;s Office or the European Commission as providing an &quot;adequate&quot;
        level of data protection equivalent to UK or EU standards in all cases. US law enforcement and
        intelligence agencies may be able to access data held by US-based cloud providers under US law
        (including FISA Section 702 and Executive Order 12333), and the remedies available to non-US
        persons in US courts may be more limited than under UK or EU law. Microsoft Azure is certified
        under the EU-US Data Privacy Framework and its UK Extension, which provides additional safeguards
        at the infrastructure layer, but your direct relationship with WadeCV relies on the Article 49(1)(b)
        contract necessity basis described above.
      </p>
      <p>
        <strong>Your controls.</strong> You can avoid the transfer by not creating an account or not
        submitting CV data. If you have already created an account and change your mind, you can delete
        your account at any time via <strong>Settings &gt; Delete Account</strong>, which permanently
        removes all your data from our systems within 30 days (see Section 6 Data Retention).
      </p>
      ...
      <ul>
        ...
        <li><strong>Deletion (Erasure):</strong> Delete your account and all associated data through Settings &gt; Delete Account.</li>
        ...
        <li><strong>Withdraw consent:</strong> Where we rely on consent (for example, analytics storage in the UK/EEA), you can withdraw it at any time via <a href="/legal/privacy-choices">Your Privacy Choices</a>.</li>
      </ul>
      <p>
        <strong>UK and EEA users:</strong> In addition to the rights above, you have the right to lodge a
        complaint with a supervisory authority if you believe we have infringed your data protection rights.
        In the United Kingdom this is the Information Commissioner&apos;s Office
        (<a href="https://ico.org.uk/make-a-complaint/" rel="noopener noreferrer" target="_blank">ico.org.uk</a>).
        In the EEA this is the data protection authority of your country of residence. We encourage you to
        contact us first at <a href="mailto:support@wadecv.com">support@wadecv.com</a> so we can try to resolve
