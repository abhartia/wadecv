export default function RefundPage() {
  return (
    <article className="prose dark:prose-invert max-w-none">
      ...
      <p>
        WadeCV credits are digital goods purchased through our platform. Our refund policy is as
        follows:
      </p>
      ...
      <ul>
        <li>
          If you have not used any credits from a purchased pack, you may request a full refund
      ...
      <ul>
        ...
        <li>
          We may, at our discretion, offer a partial refund for the unused portion within 14 days of
          purchase.
        </li>
      </ul>
      ...
      <ol>
        <li>
          Email <a href="mailto:support@wadecv.com">support@wadecv.com</a> with the subject line
          &quot;Refund Request.&quot;
        </li>
      ...
      <p>
        If you experience a technical issue that results in a failed CV generation where your credit
        was deducted but no CV was produced, please contact us. We will either:
      </p>
      <ul>
      ...
      <p>
        ...
        Please request a refund before deleting your account if you have unused credits you&apos;d
        like refunded.
      </p>
