...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    {
      url: `${BASE_URL}/legal/ai-disclosure`,
      lastModified: lastmod,
      changeFrequency: "yearly",
      priority: 0.3,
    },
    ...
    {
      url: `${BASE_URL}/physical-mail`,
      lastModified: lastmod,
      changeFrequency: "weekly",
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/ai-resume-builder-comparison`,
      lastModified: lastmod,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/best-ai-resume-builder-2026`,
      lastModified: lastmod,
      changeFrequency: "monthly",
      priority: 0.9,
    },
    {
      url: `${BASE_URL}/wadecv-vs-teal`,
      lastModified: lastmod,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/wadecv-vs-jobscan`,
      lastModified: lastmod,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/wadecv-vs-wobo`,
      lastModified: lastmod,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/wadecv-vs-flowcv`,
      lastModified: lastmod,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/wadecv-vs-rezi`,
      lastModified: lastmod,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/wadecv-vs-jobcopilot`,
      lastModified: lastmod,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/wadecv-vs-zety`,
      lastModified: lastmod,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/wadecv-vs-aiapply`,
      lastModified: lastmod,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/wadecv-vs-enhancv`,
      lastModified: lastmod,
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${BASE_URL}/wadecv-vs-claude`,
      lastModified: lastmod,
      changeFrequency: "monthly",
      priority: 0.9,
    },
    {
      url: `${BASE_URL}/wadecv-vs-resumeai`,
      lastModified: lastmod,
      changeFrequency: "monthly",
      priority: 0.9,
    },
    ...
    {
      url: `${BASE_URL}/wadecv-vs-kickresume`,
      lastModified: lastmod,
      changeFrequency: "monthly",
      priority: 0.9,
    },
    {
      url: `${BASE_URL}/wadecv-vs-novoresume`,
      lastModified: lastmod,
      changeFrequency: "monthly",
      priority: 0.9,
    },
    ...
    {
      url: `${BASE_URL}/humanize-ai-resume`,
      lastModified: lastmod,
      changeFrequency: "monthly",
      priority: 0.9,
    },
    {
      url: `${BASE_URL}/free-cv-builder-uk`,
      lastModified: lastmod,
      changeFrequency: "monthly",
      priority: 0.9,
    },
    ...
    {
      url: `${BASE_URL}/consulting-resume`,
      lastModified: lastmod,
      changeFrequency: "monthly",
      priority: 0.9,
    },
    {
      url: `${BASE_URL}/investment-banking-resume`,
      lastModified: lastmod,
      changeFrequency: "monthly",
      priority: 0.9,
    },
    ...
    {
      url: `${BASE_URL}/digital-marketing-resume`,
      lastModified: lastmod,
      changeFrequency: "monthly",
      priority: 0.9,
    },
